...
namespace tars
{
    ...
    public:
        ...
        tars::JsonValueObjPtr writeToJson() const
        {
            ...
            p->value["iVersion"] = tars::JsonOutput::writeJson(iVersion);
            p->value["cPacketType"] = tars::JsonOutput::writeJson(cPacketType);
            p->value["iMessageType"] = tars::JsonOutput::writeJson(iMessageType);
            p->value["iRequestId"] = tars::JsonOutput::writeJson(iRequestId);
            p->value["sServantName"] = tars::JsonOutput::writeJson(sServantName);
            p->value["sFuncName"] = tars::JsonOutput::writeJson(sFuncName);
            p->value["sBuffer"] = tars::JsonOutput::writeJson(sBuffer);
            p->value["iTimeout"] = tars::JsonOutput::writeJson(iTimeout);
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonInput::readJson(iVersion,pObj->value["iVersion"], true);
            tars::JsonInput::readJson(cPacketType,pObj->value["cPacketType"], true);
            tars::JsonInput::readJson(iMessageType,pObj->value["iMessageType"], true);
            tars::JsonInput::readJson(iRequestId,pObj->value["iRequestId"], true);
            tars::JsonInput::readJson(sServantName,pObj->value["sServantName"], true);
            tars::JsonInput::readJson(sFuncName,pObj->value["sFuncName"], true);
            tars::JsonInput::readJson(sBuffer,pObj->value["sBuffer"], true);
            tars::JsonInput::readJson(iTimeout,pObj->value["iTimeout"], true);
            tars::JsonInput::readJson(context,pObj->value["context"], true);
    ...
    public:
        ...
        tars::JsonValueObjPtr writeToJson() const
        {
            ...
            p->value["sBuffer"] = tars::JsonOutput::writeJson(sBuffer);
            p->value["status"] = tars::JsonOutput::writeJson(status);
            p->value["sResultDesc"] = tars::JsonOutput::writeJson(sResultDesc);
            p->value["context"] = tars::JsonOutput::writeJson(context);
            return p;
        }
        string writeToJsonString() const
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonInput::readJson(sBuffer,pObj->value["sBuffer"], true);
            tars::JsonInput::readJson(status,pObj->value["status"], true);
            tars::JsonInput::readJson(sResultDesc,pObj->value["sResultDesc"], false);
