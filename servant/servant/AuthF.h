...
namespace tars
{
    ...
    public:
        ...
        virtual void callback_applyToken(tars::ApplyTokenResponse&& ret)
        { callback_applyToken(ret); }
        ...
        virtual void callback_getTokens(vector<tars::TokenResponse>&& ret)
        { callback_getTokens(ret); }
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            pair<string*, string*> r = equal_range(__Auth_all, __Auth_all+4, (it==_msg_->response->status.end())?_msg_->request.sFuncName:it->second);
            ...
            switch(r.first - __Auth_all)
            {
                case 0:
                {
                    ...
                    {
                        callback_applyToken_exception(_msg_->response->iRet);
                    ...
                    callback_applyToken(std::move(_ret));
                ...
                case 1:
                {
                    if (_msg_->response->iRet != tars::TARSSERVERSUCCESS)
                    {
                        callback_authProcess_exception(_msg_->response->iRet);
                ...
                case 2:
                {
                    if (_msg_->response->iRet != tars::TARSSERVERSUCCESS)
                    {
                        callback_deleteToken_exception(_msg_->response->iRet);
                ...
                case 3:
                {
                    if (_msg_->response->iRet != tars::TARSSERVERSUCCESS)
                    {
                        callback_getTokens_exception(_msg_->response->iRet);
                    ...
                    callback_getTokens(std::move(_ret));
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            pair<string*, string*> r = equal_range(__Auth_all, __Auth_all+4, string(_msg_->request.sFuncName));
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __Auth_all)
            {
                case 0:
    ...
    public:
        ...
        AuthProxy* tars_hash(uint32_t key)
        {
            return (AuthProxy*)ServantProxy::tars_hash(key);
        }

        AuthProxy* tars_consistent_hash(uint32_t key)
        {
    ...
    public:
        virtual ~Auth(){}
        virtual tars::ApplyTokenResponse applyToken(const tars::ApplyTokenRequest & request,tars::TarsCurrentPtr _current_) = 0;
        virtual tars::ApplyTokenResponse applyToken(tars::ApplyTokenRequest && request,tars::TarsCurrentPtr _current_) 
        { return applyToken(request, _current_); }
        static void async_response_applyToken(tars::TarsCurrentPtr _current_, const tars::ApplyTokenResponse &_ret)
        {
        ...
        static void async_response_push_applyToken(tars::CurrentPtr _current_, const tars::ApplyTokenResponse &_ret, const map<string, string> &_context = tars::Current::TARS_STATUS())
        {
            {
                tars::TarsOutputStream<tars::BufferWriterVector> _os;
                _os.write(_ret, 0);

                _current_->sendPushResponse( tars::TARSSERVERSUCCESS ,"applyToken", _os, _context);
            }
        }

        virtual tars::Int32 authProcess(const tars::AuthRequest & request,tars::TarsCurrentPtr _current_) = 0;
        virtual tars::Int32 authProcess(tars::AuthRequest && request,tars::TarsCurrentPtr _current_) 
        { return authProcess(request, _current_); }
        static void async_response_authProcess(tars::TarsCurrentPtr _current_, tars::Int32 _ret)
        {
            if (_current_->getRequestVersion() == TUPVERSION )
            {
                UniAttribute<tars::BufferWriterVector, tars::BufferReader>  _tarsAttr_;
        ...
        static void async_response_push_authProcess(tars::CurrentPtr _current_, tars::Int32 _ret, const map<string, string> &_context = tars::Current::TARS_STATUS())
        {
            {
                tars::TarsOutputStream<tars::BufferWriterVector> _os;
                _os.write(_ret, 0);

                _current_->sendPushResponse( tars::TARSSERVERSUCCESS ,"authProcess", _os, _context);
            }
        }

        virtual tars::Int32 deleteToken(const tars::DeleteTokenRequest & request,tars::TarsCurrentPtr _current_) = 0;
        virtual tars::Int32 deleteToken(tars::DeleteTokenRequest && request,tars::TarsCurrentPtr _current_) 
        { return deleteToken(request, _current_); }
        static void async_response_deleteToken(tars::TarsCurrentPtr _current_, tars::Int32 _ret)
        {
            if (_current_->getRequestVersion() == TUPVERSION )
            {
                UniAttribute<tars::BufferWriterVector, tars::BufferReader>  _tarsAttr_;
        ...
        static void async_response_push_deleteToken(tars::CurrentPtr _current_, tars::Int32 _ret, const map<string, string> &_context = tars::Current::TARS_STATUS())
        {
            {
                tars::TarsOutputStream<tars::BufferWriterVector> _os;
                _os.write(_ret, 0);

                _current_->sendPushResponse( tars::TARSSERVERSUCCESS ,"deleteToken", _os, _context);
            }
        }

        virtual vector<tars::TokenResponse> getTokens(const tars::TokenRequest & request,tars::TarsCurrentPtr _current_) = 0;
        virtual vector<tars::TokenResponse> getTokens(tars::TokenRequest && request,tars::TarsCurrentPtr _current_) 
        { return getTokens(request, _current_); }
        static void async_response_getTokens(tars::TarsCurrentPtr _current_, const vector<tars::TokenResponse> &_ret)
        {
            if (_current_->getRequestVersion() == TUPVERSION )
            {
                UniAttribute<tars::BufferWriterVector, tars::BufferReader>  _tarsAttr_;
        ...
        static void async_response_push_getTokens(tars::CurrentPtr _current_, const vector<tars::TokenResponse> &_ret, const map<string, string> &_context = tars::Current::TARS_STATUS())
        {
            {
                tars::TarsOutputStream<tars::BufferWriterVector> _os;
                _os.write(_ret, 0);

                _current_->sendPushResponse( tars::TARSSERVERSUCCESS ,"getTokens", _os, _context);
            }
        }
        ...
        int onDispatch(tars::TarsCurrentPtr _current, vector<char> &_sResponseBuffer)
        {
            ...
            switch(r.first - __tars__Auth_all)
            {
                case 0:
                {
                    ...
                    tars::ApplyTokenResponse _ret = applyToken(std::move(request), _current);
                ...
                case 1:
                {
                    ...
                    tars::Int32 _ret = authProcess(std::move(request), _current);
                    if(_current->isResponse())
                    {
                        if (_current->getRequestVersion() == TUPVERSION)
                        {
                ...
                case 2:
                {
                    ...
                    tars::Int32 _ret = deleteToken(std::move(request), _current);
                    if(_current->isResponse())
                    {
                        if (_current->getRequestVersion() == TUPVERSION)
                        {
                ...
                case 3:
                {
                    ...
                    vector<tars::TokenResponse> _ret = getTokens(std::move(request), _current);
                    if(_current->isResponse())
                    {
                        if (_current->getRequestVersion() == TUPVERSION)
                        {
