...
namespace tars
{
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            pair<string*, string*> r = equal_range(__AdminF_all, __AdminF_all+2, (it==_msg_->response->status.end())?_msg_->request.sFuncName:it->second);
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            pair<string*, string*> r = equal_range(__AdminF_all, __AdminF_all+2, string(_msg_->request.sFuncName));
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __AdminF_all)
            {
                case 0:
    ...
    public:
        ...
        AdminFProxy* tars_hash(uint32_t key)
        {
            return (AdminFProxy*)ServantProxy::tars_hash(key);
        }

        AdminFProxy* tars_consistent_hash(uint32_t key)
        {
