...
namespace tars
{
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            pair<string*, string*> r = equal_range(__PropertyF_all, __PropertyF_all+1, (it==_msg_->response->status.end())?_msg_->request.sFuncName:it->second);
            ...
            switch(r.first - __PropertyF_all)
            {
                case 0:
                {
                    ...
                    {
                        callback_reportPropMsg_exception(_msg_->response->iRet);
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            pair<string*, string*> r = equal_range(__PropertyF_all, __PropertyF_all+1, string(_msg_->request.sFuncName));
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __PropertyF_all)
            {
                case 0:
    ...
    public:
        ...
        PropertyFProxy* tars_hash(uint32_t key)
        {
            return (PropertyFProxy*)ServantProxy::tars_hash(key);
        }

        PropertyFProxy* tars_consistent_hash(uint32_t key)
        {
    ...
    public:
        virtual ~PropertyF(){}
        virtual tars::Int32 reportPropMsg(const map<tars::StatPropMsgHead, tars::StatPropMsgBody> & statmsg,tars::TarsCurrentPtr _current_) = 0;
        virtual tars::Int32 reportPropMsg(map<tars::StatPropMsgHead, tars::StatPropMsgBody> && statmsg,tars::TarsCurrentPtr _current_) 
        { return reportPropMsg(statmsg, _current_); }
        static void async_response_reportPropMsg(tars::TarsCurrentPtr _current_, tars::Int32 _ret)
        {
        ...
        static void async_response_push_reportPropMsg(tars::CurrentPtr _current_, tars::Int32 _ret, const map<string, string> &_context = tars::Current::TARS_STATUS())
        {
            {
                tars::TarsOutputStream<tars::BufferWriterVector> _os;
                _os.write(_ret, 0);

                _current_->sendPushResponse( tars::TARSSERVERSUCCESS ,"reportPropMsg", _os, _context);
            }
        }
            ...
            switch(r.first - __tars__PropertyF_all)
            {
                case 0:
                {
                    ...
                    if (_current->getRequestVersion() == TUPVERSION)
                    {
                        ...
                        _tarsAttr_.get("statmsg", statmsg);
                    }
                    ...
                    tars::Int32 _ret = reportPropMsg(std::move(statmsg), _current);
